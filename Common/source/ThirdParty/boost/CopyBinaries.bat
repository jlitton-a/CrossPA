...
SET BoostBinFolder=%ProgramFiles%\boost\boost_1_72_0\bin.v2
...
if [%1]==[] (
   ...
   SET DEBUG_PATH=debug\%threadingtype%
   SET RELEASE_PATH=release\debug-symbols-on\%threadingtype%
   SET ALT_DEBUG_PATH=debug\threadapi-win32\%threadingtype%
   SET ALT_RELEASE_PATH=\release\debug-symbols-on\threadapi-win32\%threadingtype%
) else (
