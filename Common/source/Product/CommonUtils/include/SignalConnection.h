//Original source code was taken from https://coderwall.com/p/u4w9ra/implementing-signals-in-c-11
//Licensed under the MIT License https://opensource.org/licenses/MIT
//Copyright (c) 2016 Miguel Ibero
...
namespace Common
{
   ...
   public:
      ...
      Connection connect(const Callback& callback)
      {
         ...
         Connection pConnect = Connection(*this, item);
         return pConnect;
      }
   ...
   public:
      ...
      virtual ~ScopedSignalConnection()
      {
         this->disconnect();
      }
