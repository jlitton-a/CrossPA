...
SET APP_BUILD_DIR=%APP_MAIN_CMAKE_DIR%\build_%TARGET_NAME%\%TARGET_CONFIG%

SET APP_OUTPUT_PREFIX=%APP_WORKSPACE%\output_%TARGET_NAME%\%TARGET_CONFIG%
SET APP_RELEASE_OUT_HOME=%APP_OUTPUT_PREFIX%\Release
SET APP_RELEASEWITHDEB_OUT_HOME=%APP_OUTPUT_PREFIX%\RelWithDebInfo
SET APP_DEBUG_OUT_HOME=%APP_OUTPUT_PREFIX%\Debug
SET APP_TEST_OUT_HOME=%APP_OUTPUT_PREFIX%\Test
