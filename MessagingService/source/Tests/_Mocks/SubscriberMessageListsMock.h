...
public:
   ...
   MOCK_METHOD1(AddSentMessage, bool(Matrix::MsgService::CommonMessages::Header msg));
   ...
   MOCK_METHOD1(AddToNeedToAckList, void(const Matrix::MsgService::CommonMessages::Header* ));
