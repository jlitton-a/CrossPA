...
namespace CommunicationUtils
{
   ...
   public:
      ...
      virtual bool AddSentMessage(Matrix::MsgService::CommonMessages::Header msg) override;
      /// <summary>
      ...
      virtual void AddToNeedToAckList(const Matrix::MsgService::CommonMessages::Header* pMsg);
      /// <summary>
